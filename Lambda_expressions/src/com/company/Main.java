...
public class Main {
    ...
    public List filter1(List<Patient> patients, String diagnosis1) {
    ...
    public List filter2(List<Patient> patients, int a, int b)  {
        List<Patient> tmp = patients.stream()
    ...
    public List filter3(List<Patient> patients, char c) {
        List<Patient> tmp = patients.stream()
    ...
    public Map filter4(List<Patient> patients) {
    ...
    public Set filter5(List<Patient> patients) {
    ...
    public Map filter6(List<Patient> patients) {
        Map<String, Long> tmp1 = patients.stream()
                .collect(Collectors.groupingBy(Patient::getDiagnosis,Collectors.counting()));
        return tmp1;
    }
